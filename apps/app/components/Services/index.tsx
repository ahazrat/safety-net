...
const CARDS = [
	...
	{ text1: 'Feature', text2: 'Listings', text3: 'freelance work', text4: 'earn money by providing safety and security for your local neighborhood', link: 'Listings', actionLabel: 'Tap to browse open listings →' },
